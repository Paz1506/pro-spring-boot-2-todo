...
import com.apress.todo.domian.ToDo;
import com.apress.todo.domian.ToDoBuilder;
...
public class ToDoController {
    ...
    public ResponseEntity<?> createToDo(@Valid @RequestBody ToDo toDo,  // hibernate-validator for @NotBlank/@NotEmpty fields
                                        Errors errors) {
        if (errors.hasErrors()) {
